	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--info">
				...
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="shop.php" class="footer-nav__link">The Nursery's</a>
					</li>
					<li class="footer-nav__item">
						<a href="../controller/index.php" class="footer-nav__link">Local stores</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="checkout.php" class="footer-nav__link">Log in</a>
					</li>
					<li class="footer-nav__item">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:01643831573">01643831573</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@plantify.com" class="email__addr">support@plantify.com</a>
				</div>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Award winner</span><br> Shaik Shiraj award-2016
			</div>
